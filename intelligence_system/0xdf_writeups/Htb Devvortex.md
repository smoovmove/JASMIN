...
This is very similar to the vulnerability I exploited in [Sau](/2024/01/06/htb-sau.html#exploit-less) where `systemctl` opened in `less` and I could break out.
