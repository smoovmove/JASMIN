...
date: 2023-09-28T09:00:00+00:00
difficulty: Medium [30]
os: Windows
tags: ctf, hackthebox, htb-aero, nmap, windows, windows11, iis-arr, feroxbuster, themebleed, cve-2023-38146, msstyles, dll, youtube, visual-studio, cpp, cff-explorer, dll-reverse-shell, cve-2023-28252, nokoyawa, filesystemwatcher, htb-helpline, oscp-plus-v3, oscp-like-v3
---

![Aero](/img/aero-cover.png)
...
| Name | [Aero](https://hackthebox.com/machines/aero)  [Aero](https://hackthebox.com/machines/aero) [Play on HackTheBox](https://hackthebox.com/machines/aero) |
| --- | --- |
...
![image-20230926081003612](/img/image-20230926081003612.png)
[![expand](/icons/expand.png)](javascript:void(0) "Click to expand for full content")

Towards the bottom there’s a form to upload custom themes:

![image-20230926081129731](/img/image-20230926081129731.png)
...
![image-20230926084611408](/img/image-20230926084611408.png)

I’ll make a dummy file, `test.theme`, and upload it, and it takes:

![image-20230926084529399](/img/image-20230926084529399.png)
...
![image-20230926082127878](/img/image-20230926082127878.png)
...
I’ve got a reverse shell DLL in my [CTF Scripts repo](https://gitlab.com/0xdf/ctfscripts/-/tree/master/rev_shell_dll?ref_type=heads) that I used for the [Helpline HTB box](/2019/08/17/htb-helpline-win.html#payload). It won’t work here because it pulls from the local environment variables to get the callback IP and port. It also run the reverse shell on DLL load, where as the instructions for the POC say to use the `VerifyThemeVersion` function.
...
![image-20230926102531429](/img/image-20230926102531429.png)

I’ll name the project and get a folder for it:

![image-20230926123358322](/img/image-20230926123358322.png)
...
![image-20230926123703993](/img/image-20230926123703993.png)
...
![image-20230926123753275](/img/image-20230926123753275.png)
...
![image-20230926124753014](/img/image-20230926124753014.png)

Running it with `rundll32` will show it works:

![image-20230926124826895](/img/image-20230926124826895.png)
...
![image-20230926133614570](/img/image-20230926133614570.png)
...
![image-20230926164349274](/img/image-20230926164349274.png)
...
![image-20230926164832525](/img/image-20230926164832525.png)

I’ll replace `notepad.exe` with PowerShell #3 (Base64) from [revshells.com](https://www.revshells.com/):

![image-20230926164949303](/img/image-20230926164949303.png)
...
![image-20230926165207728](/img/image-20230926165207728.png)
...
![image-20230926165332566](/img/image-20230926165332566.png)
